...
+function(a) {
    ...
    b.prototype.setState = function(b) {
        ...
        setTimeout(a.proxy(function() {
            ...
            if (b == "loadingText") {
                this.isLoading = true;
                d.addClass(c).attr(c, c).prop(c, true);
            } else if (this.isLoading) {
                this.isLoading = false;
                d.removeClass(c).removeAttr(c).prop(c, false);
            }
        }, this), 0);
    };
    ...
    a(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(b) {
        ...
        c.call(d, "toggle");
        if (!a(b.target).is('input[type="radio"], input[type="checkbox"]')) {
            b.preventDefault();
            if (d.is("input,button")) d.trigger("focus"); else d.find("input:visible,button:visible").first().trigger("focus");
        }
...
+function(a) {
    ...
    b.prototype.enforceFocus = function() {
        a(document).off("focusin.bs.modal").on("focusin.bs.modal", a.proxy(function(a) {
            if (document !== a.target && this.$element[0] !== a.target && !this.$element.has(a.target).length) {

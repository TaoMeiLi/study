...
export default React.createClass({
	_baseVars() {
		let
			{data} = this.state,
			{totalPrice, deduct, couponDeductMoney, couponValue, allCoupons, couponShow, couponSelectedUid, couponSelectedData, usePriorityLogic} = data,
			...
			data.couponValue = couponValue ? couponValue : 0;
			data.couponDeductMoney = data.maxCouponPay>couponValue ? ( totalPrice>couponValue ?couponValue : totalPrice ): data.maxCouponPay;
			console.log(1,this.state);
		return {data, totalPrice, deduct, couponDeductMoney, couponValue, allCoupons, couponShow, couponSelectedUid, couponSelectedData, usePriorityLogic, hasDeduct};
	},
	_getDeduct(id) {
	...
	_payVars() {
		let
			{data, totalPrice, deduct, couponDeductMoney, couponValue, allCoupons, couponShow, couponSelectedUid, couponSelectedData, usePriorityLogic, hasDeduct} = this._baseVars(),
	...
	_calcPayPart() {
		...
		let {data, totalPrice, deduct, couponDeductMoney, couponValue, allCoupons, couponShow, couponSelectedUid, couponSelectedData, usePriorityLogic, hasDeduct} = this._baseVars();
	...
	onConfirm (couponSelectedUid,couponSelectedData, couponValue, vouchers, gifts) {
...
let CouponList = React.createClass({
	...
	confirm() {
		let couponValue = 0, vouchers = 0, gifts = 0;
		...
		this.props.onConfirm(this.state.couponSelectedUid, this.state.couponSelectedData, couponValue, vouchers, gifts);
	},
	render() {
